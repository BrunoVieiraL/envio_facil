...
List<String> listImageTransportPage = [
  ...
  '${veiculosImagePath}ic_van.png',
  '${veiculosImagePath}ic_moto.png',
  '${veiculosImagePath}ic_bike.png',
  '${veiculosImagePath}ic_trem.png',
...
List<String> listImageBoxSizePage = [
  ...
  '${containerImagePath}ic_backpack.png',
  '${containerImagePath}ic_mala.png',
...
List<String> listPesoBalancePage = [
  'Até 1 kg',
  'Até 5 kg',
  'Até 10 kg',
  'Até 20 kg',
...
List<String> listImageBalancePage = [
  '${balanceImagePath}ic_balance 1.png',
  '${balanceImagePath}ic_balance 2.png',
  '${balanceImagePath}ic_balance 3.png',
  '${balanceImagePath}ic_balance 4.png',
  '${balanceImagePath}ic_balance 5.png',
];

List<bool> listCheckBalancePage = [
  false,
  false,
  false,
  false,
